    ...
    public function addAction(Request $request) {
        ...
        if($form->isSubmitted()){
            if($form->isValid()) {
                ...
                if($flush == null) {
                    $status = "The category was created correctly";
                }else {
                    $status = "Error happened to add a category!";
                }
            }else {
                $status = "The category wasn't created correctly, because the form isn't valid";
            }
